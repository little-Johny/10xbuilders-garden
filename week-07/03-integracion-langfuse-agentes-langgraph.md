...
- Conexión interna: [Observabilidad y Evaluación en Sistemas de IA](./01-observabilidad-y-evaluacion-en-sistemas-de-ia.md) — el marco (ilusión operativa, stack de 4 capas) que esta clase instrumenta.
- Conexión interna: [Evaluación y Observabilidad de Agentes de IA](./02-evaluacion-y-observabilidad-de-agentes-de-ia.md) — las trazas capturadas aquí son la materia prima del *trajectory eval* y del ciclo de mejora continua.
